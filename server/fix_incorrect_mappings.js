...
async function fixIncorrectMappings() {
  ...
  const testIngredients = ['milk', 'bread', 'sour cream', 'cream cheese', 'garlic', 'tomato', 'potato', 'onion', 'ham', 'salmon', 'shrimp', 'rice', 'pasta', 'honey', 'vinegar', 'soy sauce', 'mustard', 'walnut'];
