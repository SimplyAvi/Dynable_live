...
async function testApiEndpoints() {
  ...
  // 3. IngredientCategorized Categories
  await checkEndpoint('IngredientCategorized Categories', 'GET', `${BASE_URL}/foodCategories`);

  // 4. Product: foods list
  await checkEndpoint('Product IngredientCategorizeds', 'GET', `${BASE_URL}/product/foods`);
  ...
  await checkEndpoint('Recipe Search', 'POST', `${BASE_URL}/recipe/`, { search: 'chicken', excludeRecipeIngredients: [] });
