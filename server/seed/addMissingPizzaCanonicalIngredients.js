...
async function addMissingPizzaCanonicalIngredients() {
  console.log('➕ Adding Missing Pizza Canonical Ingredients...\n');
  ...
  for (const ing of missingIngredients) {
    const exists = await CanonicalIngredient.findOne({ where: { name: ing.name } });
    if (!exists) {
...
addMissingPizzaCanonicalIngredients(); 