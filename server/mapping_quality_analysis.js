...
async function mappingQualityAnalysis() {
  try {
    ...
    const canonicalStats = await db.query(`
      ...
      LEFT JOIN "IngredientToCanonicals" itc ON ci.id = itc."CanonicalIngredientId"
    ...
    const exactDuplicates = await db.query(`
      ...
      JOIN "CanonicalIngredients" ci1 ON itc1."CanonicalIngredientId" = ci1.id
      JOIN "CanonicalIngredients" ci2 ON itc2."CanonicalIngredientId" = ci2.id
    ...
    const frequentUnmapped = Array.from(unmappedIngredients)
