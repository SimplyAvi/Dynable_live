...
// Configuration for Phase 3A Test - 100 recipes
const TOTAL_RECIPES = 100;
const BATCH_SIZE = 50; // Process 50 recipes per batch
const PARALLEL_LIMIT = 5; // Process 5 recipes in parallel
const RESULTS_FILE = 'phase3a_test_results.json';

// Caching for performance
const mappingCache = new Map();
const productCache = new Map();

async function testPhase3aOptimized() {
  console.log('🧪 TESTING PHASE 3A OPTIMIZED LOGIC (100 recipes)\n');
  ...
  try {
    ...
    // Final analysis
    console.log('\n🎯 PHASE 3A TEST RESULTS (100 recipes)');
    ...
    const results = {
      ...
      topUnmapped: frequentUnmapped.slice(0, 30),
      auditTime: totalTime,
