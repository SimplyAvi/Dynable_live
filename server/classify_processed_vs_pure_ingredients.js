const { Subcategory, CanonicalIngredient } = require('./db/models');
const sequelize = require('./db/database');

async function classifyProcessedVsPureIngredients() {
  try {
    ...
    console.log(`   Pure ingredients: ${pureIngredients.length}`);
    ...
    for (const subcategory of allSubcategories) {
      ...
      for (const processedIngredient of processedIngredients) {
...
classifyProcessedVsPureIngredients(); 