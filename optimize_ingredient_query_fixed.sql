-- Optimize IngredientCategorized Query to Prevent Timeouts - FIXED VERSION
-- This script adds indexes and optimizes the query structure using exact column names
