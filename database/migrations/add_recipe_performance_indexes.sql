...
-- Date: January 2025
-- 
-- This migration adds performance indexes to prevent timeouts in recipe processing
-- Focus: RecipeIngredients table and related performance optimizations

-- =============================================================================
-- RECIPE INGREDIENTS PERFORMANCE INDEXES
-- =============================================================================

-- 🚀 CRITICAL: Add index on RecipeId for fast recipe ingredient lookups
-- This prevents the "canceling statement due to statement timeout" error
