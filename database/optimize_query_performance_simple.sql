...
CREATE INDEX IF NOT EXISTS idx_ingredientcategorized_description_allergens
ON "IngredientCategorized" (description, allergens)
WHERE description IS NOT NULL;

-- 3. Add index for pagination performance
CREATE INDEX IF NOT EXISTS idx_ingredientcategorized_id_pagination
ON "IngredientCategorized" (id)
WHERE id IS NOT NULL;

-- 4. Add index for brand name filtering
CREATE INDEX IF NOT EXISTS idx_ingredientcategorized_brandname
