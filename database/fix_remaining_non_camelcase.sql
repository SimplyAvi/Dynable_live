-- 🎯 FIX REMAINING NON-CAMELCASE ALLERGENS
-- Fix the 27 remaining non-camelCase allergens in IngredientCategorized
...
BEGIN
    ...
    LOOP
        standardized_allergen := CASE LOWER(allergen)
            ...
            -- Additional mappings for the remaining non-camelCase
...
-- Step 2: Update the remaining non-camelCase allergens
...
-- Step 4: Verification
SELECT 'Remaining non-camelCase allergens fixed!' as status; 