...
class IngredientSeparationPipeline {
    constructor() {
        this.rules = FINAL_CLASSIFICATION_RULES;
    ...
    // STAGE 2C: Update rules based on review
    ...
    // STAGE 4: Update database with classifications
    ...
    // MASTER RUNNER with review loops
    async runIterativePipeline(config = {}) {
        console.log('🚀 Starting Master Separation Pipeline...\n');
        ...
        console.log('\n🎉 Master Separation Pipeline Complete!');
...
async function runPipelineExamples() {
    ...
    console.log('🎯 Pipeline Usage Examples:\n');
    
    // Example 1: Test small batch first
    console.log('1️⃣ Test small batch (1000 products):');
    ...
    // Example 2: Scale up incrementally
    console.log('\n2️⃣ Scale up (10,000 products):');
    await pipeline.runIterativePipeline({ 
        stages: ['classify'], 
