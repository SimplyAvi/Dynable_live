...
async function testFilteringLogic() {
    ...
    try {
        ...
        const response = await axios.get('http://process.env.API_URL || 'localhost:5001'/api/product/foods?page=1&limit=10');
        ...
        try {
            const subcatResponse = await axios.get('http://process.env.API_URL || 'localhost:5001'/api/subcategories');
        ...
        const sugarResponse = await axios.post('http://process.env.API_URL || 'localhost:5001'/api/product/foods', {
            name: 'sugar'
        }, {
        ...
        const allProductsResponse = await axios.get('http://process.env.API_URL || 'localhost:5001'/api/product/foods?page=1&limit=100');
        ...
        try {
            const directResponse = await axios.get('http://process.env.API_URL || 'localhost:5001'/api/product/foods?page=1&limit=10');
