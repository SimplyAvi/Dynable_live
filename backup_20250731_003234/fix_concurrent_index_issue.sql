...
-- These commands work in Supabase SQL Editor (no transaction blocks)

-- Step 1: Enable trigram extension
CREATE EXTENSION IF NOT EXISTS pg_trgm;

-- Step 2: Create trigram index (MOST CRITICAL)
-- Note: Removed CONCURRENTLY to work in Supabase SQL Editor
...
-- Step 4: Create brand filter index
